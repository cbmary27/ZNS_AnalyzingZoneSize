...
./run-zns-exp.sh <zone size> <channels per zone> <ways per zone>
...
# ⚙️ EXPERIMENT 1: Write Amplification w.r.t Dummy Pages
...
# ⚙️ EXPERIMENT 2: Space Amplification w.r.t Invalid Data
...
# ⚙️ EXPERIMENT 3: Latency and Bandwidth
